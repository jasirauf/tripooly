  ...
  return (
    <div className="home-page">
      ...
      <div className="category-bar">
        ...
        <Link to="/stays" className="category-item">
          <Heart size={16} /> <span>Local Stays</span>
        </Link>
        <Link to="/connections" className="category-item">
      ...
      <div className="package-grid-container" id="packages">
        <div className="section-header">
          ...
          <Link to="/" className="view-all">View all packages <ArrowRight size={16} /></Link>
        </div>
      ...
      <section className="stays-preview-section bg-light">
        <div className="package-grid-container">
          <div className="section-header">
            ...
            <Link to="/stays" className="view-all">Explore all stays <ArrowRight size={16} /></Link>
          </div>
          <motion.div 
            className="package-grid"
            initial="hidden"
